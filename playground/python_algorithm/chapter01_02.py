...
# Self 의미
studt1 = Student('Cho', 2, 3, {'gender': 'Mail', 'score1': 65, 'score2': 44})
studt2 = Student('Chang', 2, 3, {'gender': 'Femail', 'score1': 85, 'score2': 74}, 'stu2@naver.com')
...
# 인스턴스 변수
# 직접 접근(PEP 문법적으로 권장하지 않는다.)
# studt1._name = 'HAHAHA' # 직접 접근
